...
class Post(models.Model):
    ...
    # Recurrence lineage (stable link back to the source post when this post
    # was generated by ``generate_recurring_posts``).  SET_NULL so deleting
    # the source does not cascade-remove all of its recurrences.
